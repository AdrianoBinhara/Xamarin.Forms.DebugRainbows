...
public class DebugRainbow
{
    private static readonly Random _randomGen = new Random();
        ...
        public static readonly BindableProperty MajorGridLineColorProperty = BindableProperty.CreateAttached("MajorGridLineColor", typeof(Color), typeof(Page), Colors.Red);
        ...
        public static readonly BindableProperty GridLineColorProperty = BindableProperty.CreateAttached("GridLineColor", typeof(Color), typeof(Page), Colors.Red);
